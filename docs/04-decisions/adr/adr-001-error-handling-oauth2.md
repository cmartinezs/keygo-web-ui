...
function resolveAuthError(error: ErrorData, stage: AuthStage): AuthErrorAction {
...
| `docs/02-functional/04-auth-flow-platform-and-tenant.md` | Flujo OAuth2 completo con contexto funcional actualizado          |
| `docs/FRONTEND_DEVELOPER_GUIDE.md`                       | Portal frontend hacia arquitectura, referencia y guías operativas |
