...
export interface RegistrationData {
  id: string;
  notification_email: string; // email enmascarado (ej: j***@example.com)
  status: UserStatus;
}
...
/** Datos devueltos por GET /tenants/registration?registration_id=xxx&client_id=yyy */
export interface RegistrationSession {
  ...
  last_name: string;
  username: string;
  status: 'PENDING' | 'EMAIL_VERIFIED' | 'ACTIVE' | 'EXPIRED';
}
