      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          <button
            ...
            aria-label={t('landing.nav.backToTopAria')}
          >
            <svg
            ...
            <span className="hidden lg:inline text-white font-bold text-xl tracking-tight">KeyGo</span>
          </button>

          <nav className="hidden md:flex items-center gap-6" aria-label={t('landing.nav.primaryAria')}>
          ...
          <div className="relative flex items-center gap-2" ref={dropdownRef}>
            <LocaleSwitcher
              ...
              selectedValueClassName="hidden lg:inline font-semibold text-white"
            />
            <button
